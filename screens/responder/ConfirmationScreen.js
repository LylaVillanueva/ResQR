...
export default function ConfirmationScreen({ route, navigation }) {
  ...
  function handleConfirm() {
    ...
    const myCurrentStatus = target.responderStatus;
    ...
    updateAlertConfirmation(alertId, 'responder', nextStatus, RESPONDER_NAME);
    setConfirmed(true);
  }
  ...
  const bullets = isSafe
    ? [
        ...
        'The alert will remain open until the guardian also confirms.',
