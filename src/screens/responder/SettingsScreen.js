    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <View style={styles.profileBar}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.meta}>Barangay Responder • {account.barangayName}</Text>
          </View>
        </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Section compact title={t('accountInformation')} titleStyle={{ marginTop: 10 }}>
          ...
          <InfoRow label={t('position')} value="Barangay Responder" />
        ...
        <Section compact title={t('helpSupport')}>
          ...
          <Divider />
          <LinkRow compact icon="phone" label={t('barangayContactNumber')} value="View contact" onPress={() => info('Barangay Contact', 'Ask your barangay office for its official contact number.')} />
          <Divider />
