...
const modelsUrl = asModule(fs.readFileSync(path.join(__dirname, "./lib/models.js"), 'utf8'));
const models = import(modelsUrl);
const service = import(asModule(fs.readFileSync(path.join(__dirname, "./lib/appData.js"), 'utf8').replace("'./models'", JSON.stringify(modelsUrl))));
